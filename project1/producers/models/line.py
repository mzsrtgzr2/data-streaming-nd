...
class Line:
    ...
    def __init__(self, color, station_data, num_trains=10):
        logger.info('--init line color %s--', color)
        self.color = color
        self.num_trains = num_trains
        self.stations = self._build_line_data(station_data)
        logger.info('--finish build line data %s--', color)
        ...
        logger.info('--end line color %s--', color)
    ...
    def _build_line_data(self, station_df):
        ...
        for station in stations[1:]:
            ...
            logger.info('--creation station %s--', station)
            new_station = Station(
            ...
            logger.info('--end create station %s--', station)
